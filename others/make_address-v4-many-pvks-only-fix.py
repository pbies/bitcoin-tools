...
def show_info(point: Tuple[int, int], scalar: int, *, p2pkh: bool = False, uncompressed: bool = False, testnet: bool = False) -> None:
    ...
    private_key: str = (('' if uncompressed else '') if p2pkh else '') + wif_from_scalar(scalar, uncompressed=uncompressed, testnet=testnet)
    print(private_key)
def self_test() -> bool:
