...
start = time.time()
a_all=open('puzzle addrs.txt','r').readlines()
end = time.time()
...
for i in range(1,r+1):
	t.append(random.randint(0x20000000000000000,0x10000000000000000000000000000000000000000))

print('Searching...')

process_map(go, t, max_workers=10, chunksize=1000)
