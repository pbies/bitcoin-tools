...
# Konfiguracja Web3
INFURA_URL = "https://mainnet.infura.io/v3/4246036b6cac41be88a43a5955ff5866"  # Replace with your Infura Project ID
...
UNISWAP_ROUTER_ADDRESS = "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"  # Uniswap V2 Router Address (V3 is different)
SUSHISWAP_ROUTER_ADDRESS = "0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac"  # SushiSwap Router Address

# ABI routera (Uniswap V2 and SushiSwap are very similar)
ROUTER_ABI = [  # Combined ABI for both (most important functions)
	{
		"constant": True,
		"inputs": [
...
sushiswap_router = web3.eth.contract(address=SUSHISWAP_ROUTER_ADDRESS, abi=ROUTER_ABI)
...
def arbitrage(token_in, token_out, amount_in):
	...
	if price_uniswap is None or price_sushiswap is None:  # Check for price retrieval errors
		return
	...
	if price_uniswap > price_sushiswap * 1.005:  # Add a small slippage tolerance (0.5%)
	...
	elif price_sushiswap > price_uniswap * 1.005:  # Add slippage tolerance
