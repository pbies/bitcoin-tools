...
def pubkey_to_addrs(pk):
	...
	print()
	print(f'P2PKH:          {hdwallet.address("P2PKH")}')
	print(f'P2SH:           {hdwallet.address("P2SH")}')
	print(f'P2TR:           {hdwallet.address("P2TR")}')
	print(f'P2WPKH:         {hdwallet.address("P2WPKH")}')
	print(f'P2WPKH-In-P2SH: {hdwallet.address("P2WPKH-In-P2SH")}')
	print(f'P2WSH:          {hdwallet.address("P2WSH")}')
	print(f'P2WSH-In-P2SH:  {hdwallet.address("P2WSH-In-P2SH")}')
	print()
	return 
...
clear()
while True:
	print('Tool for cc v0.55 (C) 2023-2024 Aftermath @Tzeeck')
	...
	print('b. brainwallet to WIF - single')
	print('c. brainwallet to WIF - many (a file)')
	...
	match m:
		...
		case 'k':
			hdwallet = HDWallet(cryptocurrency=BTC, hd=BIP32HD)
			hdwallet.from_seed(seed=BIP39Seed(seed=os.urandom(64).hex()))
			pp = pprint.PrettyPrinter(indent=4)
			d = hdwallet.dump()
			print('\n'+pp.pformat(d)+'\n')
		case '1':
			...
			hdwallet = HDWallet(cryptocurrency=BTC, hd=BIP32HD)
			hdwallet.from_mnemonic(mnemonic=BIP39Mnemonic(mnemonic=j))
			d=hdwallet.dump()
			print()
			pprint.pprint(d)
			print()
