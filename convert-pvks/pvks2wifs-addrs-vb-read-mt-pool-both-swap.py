...
def go(k):
	...
	d=b+a
	try:
		hdwallet1 = HDWallet(cryptocurrency=BTC, hd=BIP32HD).from_private_key(private_key=c)
		hdwallet2 = HDWallet(cryptocurrency=BTC, hd=BIP32HD).from_private_key(private_key=d)
	except:
		return
