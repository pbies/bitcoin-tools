...
# Configuration
url = 'https://gz.blockchair.com/litecoin/addresses/blockchair_litecoin_addresses_latest.tsv.gz' # you can replace it with target url
output_file = 'blockchair_litecoin_addresses_latest.tsv.gz' # file name
