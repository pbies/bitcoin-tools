...
clear()
while True:
	print('Tool for cc v0.20 (C) 2023 Aftermath @Tzeeck')
	...
	match m:
		...
		case 'b':
			...
			if a=='':
				a='input.txt'
			print('Lines count: '+count_lines(a)+'\n')
		case 'c':
			a=input('Enter hex: ')
			print('Integer: '+hex_to_int(a)+'\n')
		case 'd':
			a=input('Enter int: ')
			print('Hex: '+int_to_hex(a)+'\n')
		case 'e':
			a=input('Enter public key: ')
			print('Address: '+pubkey_to_addr(a)+'\n')
		case 'f':
			a=input('Enter private key in hex: ')
			print('WIF: '+pvk_to_wif2(a)+'\n')
		case 'g':
			a=input('Enter private key in hex: ')
			print('Public key: '+pvk_to_wif2(a)+'\n')
		case 'h':
			a=input('Enter string: ')
			print('Hex: '+str_to_hex(a)+'\n')
		case 'i':
			a=input('Enter WIF: ')
			print('Private key: '+wif_to_pvk(a)+'\n')
		case '':
			exit(0)
